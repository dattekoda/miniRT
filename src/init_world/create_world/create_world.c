...
/*   Updated: 2026/01/19 18:36:54 by khanadat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		set_light(t_list **light_list, const t_list *line_list, t_point3 camera_origin);
int		set_objects(t_world *world, t_list *line_list);

int	create_world(t_world *world, t_list *line_list)
{
	set_ambient(&world->ambient, line_list);
